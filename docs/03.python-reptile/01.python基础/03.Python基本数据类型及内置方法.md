---
title: Python基本数据类型及内置方法
date: 2022-07-15 16:51:13
permalink: /pages/95339a/
categories:
  - python逆向爬虫
tags:
  - 
...
name1 = '小阳爱技术'  # 本质:name = str('任意形式内容')
...
<class 'str'>
>>> type(str({"name":"小阳爱技术","age":18})) # dict->str
<class 'str'>
...
>>> list([1,2,3]) # 结果：[1, 2, 3]
>>> list({"name":"小阳爱技术","age":18}) #结果：['name', 'age']
>>> list((1,2,3)) # 结果：[1, 2, 3] 
...
>>> my_friends = ['tony','jack','小阳爱技术',4,5]
>>> my_friends[1] = 'martthow'
>>> my_friends
['tony', 'martthow', '小阳爱技术', 4, 5]
...
>>> tuple({"name":"小阳爱技术","age":18}) # 结果：('name', 'age')
>>> tuple((1,2,3)) # 结果：(1, 2, 3)
