...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: 'Python逆向爬虫',
        link: '/python-reptile/', //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
        items: [
    ...
    author: {
      name: '小阳爱技术', // 必需
      link: 'https://blog.abck8s.com', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        '小阳爱技术 | <a href="https://blog.abck8s.com" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        ...
        options: {
          ...
          owner: '小阳爱技术', // GitHub仓库所有者
          admin: ['yangyang0910'], // 对仓库有写权限的人
